...
export default async function BrokerStatementPage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-500">
        Every funding, fee, reserve, and chargeback entry tied to your invoices.
      </p>
      ...
      <form method="GET" className="flex flex-wrap items-center gap-2">
        ...
        {hasFilters && (
          <a href="/broker/statement" className="text-sm text-gray-500 hover:underline">
            Clear
          </a>
        )}
      </form>
